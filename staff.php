...
<div class="wrapper">
	 ...
	 <div id="sidebar">
		...
		<ul class="list-unstyled component m-0">
		  <li class="active">
		  <a href="#" class="dashboard"><i class="material-icons">dashboard</i>STAFF MANAGEMENT</a>
		  </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
			...
			<input type="text" name="T12" autocomplete="off" id="i1" class="form-control" required>
		</div>
		
		<div class="form-group">
		    <label>Staff ID</label>
			<input type="text" name="T23" autocomplete="off" id="i2" class="form-control" required>
		</div>
		<div class="form-group">
		    <label>Branch</label>
			<input type="text" name="T34" autocomplete="off" id="i3" class="form-control" required>
		</div>
        ...
        <button type="submit" name="submit" class="btn btn-success">Save</button>
					   ...
					   <?php
                        ...
                        $slno=0;
								...
								echo "<td>".$sidfromdb."</td>";
                                echo "<td>".$branchfromdb."</td>";
								echo  "<td><a href='deleteStaff.php?id=".$snamefromdb."'><img src='images/deleteicon.png' height='30' width='20'></a></td>";
                                echo "</tr>";	
...
<?php
								...
								{ 
									...
									{
										$q="insert into staff values('$sname','$sid','$branch')";
										$r=mysqli_query($con,$q);
										if($r)
										{
