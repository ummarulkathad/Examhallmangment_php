  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
		    <label>Name</label>
			<input type="text" name="T7" autocomplete="off" id="i7" class="form-control" required>
		</div>
		
		<div class="form-group">
		    <label>Branch</label>
			<textarea name="T6" autocomplete="off" id="i6" class="form-control" required></textarea>
		</div>
		<div class="form-group">
		    <label>Register Number</label>
			<input type="text" name="T5" autocomplete="off" id="i5" class="form-control" required>
		</div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
        ...
        <button type="button" class="btn btn-success">Delete</button>
		 ...
		 <footer class="footer">
		    <div class="container-fluid">
			   <div class="footer-in">
			      <p class="mb-0">SDM POLYTECHNIC UJIRE</p>
			   </div>
			</div>
		 </footer>
